...
public class JanelaConsultarDisciplina extends javax.swing.JDialog {

    public JanelaConsultarDisciplina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaConsultarDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JanelaConsultarDisciplina dialog = new JanelaConsultarDisciplina(new javax.swing.JFrame(), true);
