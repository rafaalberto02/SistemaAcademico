...
public class JanelaCadastrarDisciplina extends javax.swing.JDialog {

    public JanelaCadastrarDisciplina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaCadastrarDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JanelaCadastrarDisciplina dialog = new JanelaCadastrarDisciplina(new javax.swing.JFrame(), true);
