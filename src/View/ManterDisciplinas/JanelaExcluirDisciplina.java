...
public class JanelaExcluirDisciplina extends javax.swing.JDialog {

    public JanelaExcluirDisciplina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaExcluirDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JanelaExcluirDisciplina dialog = new JanelaExcluirDisciplina(new javax.swing.JFrame(), true);
