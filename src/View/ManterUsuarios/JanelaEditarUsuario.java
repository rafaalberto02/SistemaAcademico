...
public class JanelaEditarUsuario extends javax.swing.JDialog {
    
    public JanelaEditarUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JanelaEditarUsuario dialog = new JanelaEditarUsuario(new javax.swing.JFrame(), true);
